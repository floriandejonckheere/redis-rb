...
#
# source://async-io//lib/async/io/tcp_socket.rb#83
class Async::IO::TCPServer < ::Async::IO::TCPSocket
  include ::Async::IO::Server

  # @return [TCPServer] a new instance of TCPServer
  #
  # source://async-io//lib/async/io/tcp_socket.rb#86
  def initialize(*args); end

  # source://async-io//lib/async/io/tcp_socket.rb#95
  def accept(timeout: T.unsafe(nil), task: T.unsafe(nil)); end
...
# Asynchronous TCP socket wrapper.
#
# source://async-io//lib/async/io/tcp_socket.rb#30
class Async::IO::TCPSocket < ::Async::IO::IPSocket
  # @return [TCPSocket] a new instance of TCPSocket
  #
  # source://async-io//lib/async/io/tcp_socket.rb#33
  def initialize(remote_host, remote_port = T.unsafe(nil), local_host = T.unsafe(nil), local_port = T.unsafe(nil)); end

  # source://async-io//lib/async/io/tcp_socket.rb#59
  def close; end
  ...
  #
  # source://async-io//lib/async/io/tcp_socket.rb#66
  def stream; end

  # source://async-io//lib/async/io/tcp_socket.rb#71
  def sysread(size, buffer = T.unsafe(nil)); end
